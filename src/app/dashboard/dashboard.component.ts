...
declare var google: any; // declare vai fazer com a variavel 
                          //seja acessavel dentro do contexto (Integração biblioteca externa)
...
export class DashboardComponent implements OnInit {
   ...
   */
  init(): void {
    if(typeof(google) !== 'undefined') { // se (google) ela não for criada
      google.charts.load('current', {'packages':['corechart']}); //executa o carregamento dos pacotes
      setTimeout(() => {
   ...
   */
  exibirPieChart(): void {
  	const el = document.getElementById('pie_chart'); //referencia o id no html
